...
export const organizerSkillOptions = [
...
export type OrganizerSkillId = (typeof organizerSkillOptions)[number]["id"]
...
export const commitmentAgreementFields = [
  ...
  },
  {
    ...
    label: "I consent to the use of my information for organizer coordination.",
  },
] as const
